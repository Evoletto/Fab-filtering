...
for file in files_to_download:
	...
	urllib.request.urlretrieve(url, '/Users/Alina/Dropbox/Comp/Fab_filtered_RCSB/' + file)


# First get the file names with correct labels of chains and if the LC ends on CYS
directory_path = "/Users/Alina/Dropbox/Comp/Fab_filtered_RCSB/"
all_files = sorted(os.listdir(directory_path))
files_to_download = []
...
for file in files_to_download:
	...
	url = 'https://files.rcsb.org/download/' + striped_filename + ".pdb"
	print("will download file at: ",url) 
	urllib.request.urlretrieve(url, "/Users/Alina/Dropbox/Comp/Fab_filtered_CYS_on_LC/" + file)